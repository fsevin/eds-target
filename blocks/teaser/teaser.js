...
export default async function decorate(block) {
  ...
  const content = document.createRange().createContextualFragment(`
    ...
    <h2 id="teaser-15rvxhjm4-title" class="text-4xl md:text-5xl font-bold text-gray-900 leading-tight" data-aue-label="Title" data-aue-prop="title" data-aue-type="text"></h2>
